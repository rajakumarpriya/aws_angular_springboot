...
//    }
    @DeleteMapping("/delete/{statusId}")
    public ResponseEntity<String> deleteRequest(@PathVariable int statusId) throws Exception{
       // return service.deleteRequest(statusId);
        return new ResponseEntity<String>(service.deleteRequest(statusId)+" record deleted."
				, HttpStatus.OK); 
    }
}